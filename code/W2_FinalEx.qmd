...
```{r load-catch-1}
catch_path <- here::here("data/workshop2/estuary_catch_log.xlsx")

catch1 <- read_excel(catch_path, sheet = 1)
catch2 <- read_excel(catch_path, sheet = 2)
catch3 <- read_excel(catch_path, sheet = 3)
catch4 <- read_excel(catch_path, sheet = 4)
```
